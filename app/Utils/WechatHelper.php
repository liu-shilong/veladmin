...
class WechatHelper
{
     ...
     * 微信用户表
     */
    protected string $user_table = 'vel_wechat_users';

    /**
     * 微信全局access_token标
     */
    protected string $access_table = 'vel_wechat_access';

    public function __construct(bool $user_info = true, string $state = 'vel')
    {
