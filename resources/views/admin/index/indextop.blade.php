...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse tab-content" id="side-menu">
            ...
            <div class="tab-pane fade height-full" id="index">
                <ul class="nav">
                    <li>
                        <a class="menuItem" href="{{route('admin.home')}}"><i class="fa fa-home"></i> <span class="nav-label">主页</span></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <ul class="nav navbar-top-links navbar-right welcome-message">
                    ...
                    <li class="dropdown user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a onclick="toggleMenu()"><i class="fa fa-toggle-off"></i> 左侧菜单</a>
                            </li>
                            <li class="divider"></li>
                        </ul>
                    </li>
        ...
        <div class="row content-tabs">
            ...
            <nav class="page-tabs menuTabs">
                <div class="page-tabs-content">
                    <a href="javascript:;" class="active menuTab" data-id="{{route('admin.home')}}">主页</a>
                </div>
            </nav>
        ...
        <div class="footer">
            <div class="pull-right">© 2024 {{$system_name}} Copyright </div>
        </div>
    </div>
    <!--右侧部分结束-->
</div>
...
<script>
    ...
    function toggleMenu() {
        $.modal.confirm("确认要切换成左侧菜单吗？", function() {
            $.get("{{route('admin.nav-style',['type'=>'left'])}}", function(result) {
